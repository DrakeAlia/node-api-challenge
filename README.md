...
Express is a web application framework that sits on top of the Node.js web server. It allows improved workflow and better project originization by allowing you to split up into components

- [X] Describe Middleware?

Middleware functions can get the request and response objects, to be operated on them. It can be used for authentication/validation for request data.

- [X] Describe a Resource?

Resource is data that is conntected to a request that the endpoints can recieve and react to 

- [X] What can the API return to help clients know if a request was successful?

A status that tells you its been a successful http response. ex: res.status(200) being a successful return.

- [X] How can we partition our application into sub-applications?

Using express routers are a way to split an application into sub-applications to make it more modular and easier to maintain as well as work within a application
